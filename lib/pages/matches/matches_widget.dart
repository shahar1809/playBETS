...
class _MatchesWidgetState extends State<MatchesWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF070000),
        body: SafeArea(
          top: true,
          child: Column(
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset(
                            'assets/images/playstudio-logo-300x300-1.png',
                            width: 70.0,
                            height: 70.0,
                            fit: BoxFit.cover,
                          ),
              ...
              Container(
                ...
                child: StreamBuilder<List<MatchesWithTeamsRow>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<MatchesWithTeamsRow> listViewMatchesWithTeamsRowList =
                        snapshot.data!;
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewMatchesWithTeamsRowList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewMatchesWithTeamsRow =
                            listViewMatchesWithTeamsRowList[listViewIndex];
                        return Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  valueOrDefault<String>(
                                    listViewMatchesWithTeamsRow.homeLogo,
                            ...
                            Padding(
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  listViewMatchesWithTeamsRow.homeTeamShort,
                                  'home',
                                ),
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  dateTimeFormat("d/M H:mm",
                                      listViewMatchesWithTeamsRow.startsAt),
                                  'starts_at',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                            ...
                            Padding(
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  listViewMatchesWithTeamsRow.awayTeamShort,
                                  'away',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Image.network(
                                  valueOrDefault<String>(
                                    listViewMatchesWithTeamsRow.awayLogo,
                                    'https://upload.wikimedia.org/wikipedia/commons/e/ec/Soccer_ball.svg',
                                  ),
                                  fit: BoxFit.cover,
                                ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed(BetsWidget.routeName);
                        },
                        text: 'Bets',
                        options: FFButtonOptions(
                          height: 40.0,
